...
VUHDO_I18N_EMPTY_GROUPS = "Grupos vacios"; -- нету в актуале
...
VUHDO_I18N_GROUP_BUFFS = "Bufos de grupo"; -- нету в актуале
...
VUHDO_I18N_MAX_SWATCHES_PER_LINE = "Max.Indicador por Linea"; -- нету в актуале
...
VUHDO_I18N_IF_AT_LEAST = "... si por lo menos"; -- нету в актуале
VUHDO_I18N_PLAYERS_LOW = " jugadores bajos."; -- нету в актуале
...
VUHDO_I18N_NEVER = "Nunca"; -- нету в актуале
...
VUHDO_I18N_ESTIMATE = "Estimado"; -- нету в актуале
...
VUHDO_I18N_TT.K006 = "Set the maximum number of Buff Swatches per Row."; -- нету в актуале
...
VUHDO_I18N_TT.K010 = "Select to also show buff groups that are currently empty."; -- нету в актуале
...
VUHDO_I18N_TT.K024 = "Select this for rebuffing raid members due to the slider setting below."; -- нету в актуале
VUHDO_I18N_TT.K025 = "Select this to always use the single target version of your buff. (e.g. if you are out of reagents)"; -- нету в актуале
VUHDO_I18N_TT.K026 = "Select this to always use the group/raid version of your buff"; -- нету в актуале
VUHDO_I18N_TT.K027 = "Select how many party/raid members at least must be low on a buff to use the group version in favor of the single target buff version."; -- нету в актуале
...
VUHDO_I18N_TT.K320 = "Select a HoT for your 3rd slot."; -- нету в актуале
VUHDO_I18N_TT.K321 = "Select a HoT for your 2nd slot."; -- нету в актуале
VUHDO_I18N_TT.K322 = "Select a HoT for your 1st slot."; -- нету в актуале
...
VUHDO_I18N_TT.K332 = "Select a HoT for your 5th slot. Slot number 5 will not be displayed when color squares instead of icons are selected"; -- нету в актуале
VUHDO_I18N_TT.K333 = "Select a HoT for your 4th slot."; -- нету в актуале
VUHDO_I18N_TT.K334 = "Select a HoT for your 3rd slot."; -- нету в актуале
VUHDO_I18N_TT.K335 = "Select a HoT for your 2nd slot."; -- нету в актуале
VUHDO_I18N_TT.K336 = "Select a HoT for your 1st slot."; -- нету в актуале
...
VUHDO_I18N_TT.K368 = "Select the latest point in the future you want to see direct casts from."; -- нету в актуале
VUHDO_I18N_TT.K369 = "Check to show incoming heals from direct casts."; -- нету в актуале
VUHDO_I18N_TT.K370 = "Select the latest point in the future you want to see channelled heals from."; -- нету в актуале
VUHDO_I18N_TT.K371 = "Check to show incoming heals from channelled heals."; -- нету в актуале
VUHDO_I18N_TT.K372 = "Select the latest point in the future you want to see HoTs from."; -- нету в актуале
VUHDO_I18N_TT.K373 = "Check to show incoming heals from HoTs."; -- нету в актуале
VUHDO_I18N_TT.K374 = "Select the latest point in the future you want to see bombed heals from."; -- нету в актуале
VUHDO_I18N_TT.K375 = "Check to show incoming heals from bombed heals (atm: Life Bloom effect)."; -- нету в актуале
...
VUHDO_I18N_MISC_TEXT = "Misc. Text"; -- нету в актуале
...
VUHDO_I18N_CHANNELLED = "Channelled"; -- нету в актуале
VUHDO_I18N_BOMBED = "Bombed"; -- нету в актуале
VUHDO_I18N_EVENT_HORIZON = "Event Horizon"; -- нету в актуале
