...
VUHDO_I18N_EMPTY_GROUPS = "Groupes vides"; -- нету в актуале
...
VUHDO_I18N_SMART_DOTS = "Smart..."; -- нету в актуале
VUHDO_I18N_GROUP_BUFFS = "Buffs de groupe"; -- нету в актуале
...
VUHDO_I18N_MAX_SWATCHES_PER_LINE = "Max.Indicateurs par Ligne"; -- нету в актуале
...
VUHDO_I18N_IF_AT_LEAST = "... si au moins"; -- нету в актуале
VUHDO_I18N_PLAYERS_LOW = " joueurs bas."; -- нету в актуале
...
VUHDO_I18N_NEVER = "Jamais"; -- нету в актуале
...
VUHDO_I18N_ESTIMATE = "Estim\195\169"; -- нету в актуале
...
VUHDO_I18N_TT.K006 = "Fixer le nombre maximum d'indicateurs de buff par ligne."; -- нету в актуале
...
VUHDO_I18N_TT.K010 = "Afficher les buffs de groupe qui sont vides."; -- нету в актуале
...
VUHDO_I18N_TT.K024 = "Rebuffer les membres du raid en fonction du curseur ci-dessous."; -- нету в актуале
VUHDO_I18N_TT.K025 = "Toujours utiliser la version individuelle de votre buff (ex. si vous n'avez plus de composants)."; -- нету в актуале
VUHDO_I18N_TT.K026 = "Toujours utiliser la version raid de votre buff."; -- нету в актуале
VUHDO_I18N_TT.K027 = "Fixer le nombre de joueurs dont le buff est BAS \195\160 partir duquel la version raid de votre buff sera utilis\195\169e \195\160 la place de la version individuelle."; -- нету в актуале
...
VUHDO_I18N_TT.K055 = "Fixer un pourcentage max. de vie au-delа duquel les joueurs sont consid\195\169r\195\169s bien portants, ce qui signifie qu'ils seront l\195\169g\195\169rement translucide (configurable).";
...
VUHDO_I18N_TT.K092 = "Trier les joueurs au sein du panneau comme il apparaоt dans l'interface de raid Blizzard.";
...
VUHDO_I18N_TT.K157 = "Change la couleur des pouvoirs tels que mana, йnergie ou rage."
...
VUHDO_I18N_TT.K160 = "S\195\169lectionner la couleur de la barre d'йnergie."
...
VUHDO_I18N_TT.K173 = "Selectionner le taux de rafraоchissement pour la mise \195\160 jour des HoTs" -- 173
...
VUHDO_I18N_TT.K183 = "S\195\169lectionner une fr\195\169quence en ms pour le rafraоchissement de l'aggro/menace."
...
VUHDO_I18N_TT.K210 = "Entrez un texte qui sera montrй dans le chat lorsque vous dйmarrez ressusciter quelqu'un. Utilisez \"vuhdo\" comme espace rйservй pour le nom";
VUHDO_I18N_TT.K211 = "Cochezz pour voir le texte du chat, lorsque vous dйmarrez une rйsurrection. Utilisez \"vuhdo\" comme espace rйservй au texte pour le nom";
VUHDO_I18N_TT.K212 = "Cochezz entiиrement les panneaux cacher et vides.";
...
VUHDO_I18N_TT.K214 = "Cochez cette case pour ne pas montrer les assistants rйguliиrement dans les cadres raid/groupe.";
VUHDO_I18N_TT.K215 = "Cochez cette option pour rebuff les buffs manquants en hors-combat. Buffs doit кtre activй et a une couleur attribuйe а VuhDo BuffWatch.";
VUHDO_I18N_TT.K216 = "Sйlectionnez cette option pour afficher les heals entrants, provenant du raid/membres.";
VUHDO_I18N_TT.K217 = "Cochez pour ajouter entrants/overheal en texte de la vie sur les barres";
VUHDO_I18N_TT.K218 = "Modifier cette barre pour rйgler l'йchelle du texte de l'overheal.";
VUHDO_I18N_TT.K219 = "Contrфle l'affichage du texte de l'overheal dans un texte (blanc) supplйmentaire sur les barres.";
VUHDO_I18N_TT.K221 = "Cochez cette case pour montrer les buffs manquants а mi-combat.";
...
VUHDO_I18N_TT.K224 = "Sйlectionnez ce menu pour configurer les couleurs de base pour les carrйs des HoT";
VUHDO_I18N_TT.K225 = "Sйlectionnez ce menu pour une configuration avancйe des couleurs pour les carrйs HoT";
VUHDO_I18N_TT.K226 = "Organisation des couleurs de classe";
VUHDO_I18N_TT.K228 = "Cochez cette case si vous avez des couleurs de classe du familier au lieu de couleurs personnalisйes.";
...
VUHDO_I18N_TT.K233 = "Choisir une couleur - dйmonise";
VUHDO_I18N_TT.K234 = "Choisir une couleur - chaman";
VUHDO_I18N_TT.K235 = "Choisir une couleur - Druide";
VUHDO_I18N_TT.K236 = "Choisir une couleur - Prкtre";
...
VUHDO_I18N_TT.K241 = "Cochez l'affichage du numйro des HoT par la couleur du texte а gauche.";
VUHDO_I18N_TT.K242 = "Cochez l'affichage du numйro des HoT par la couleur de fond vers la gauche.";
VUHDO_I18N_TT.K243 = "Choisir une couleur pour les HoTs ayant 2 charges appliquйes";
VUHDO_I18N_TT.K244 = "Choisir une couleur pour les HoTs ayant 3 charges appliquйes";
VUHDO_I18N_TT.K245 = "Choisir une couleur pour les HoTs ayant 4 charges appliquйes";
...
VUHDO_I18N_TT.K249 = "Choisir une couleur pour les HoT carrйs 1";
VUHDO_I18N_TT.K250 = "Choisir une couleur pour les HoT carrйs 2";
VUHDO_I18N_TT.K251 = "Choisir une couleur pour les HoT carrйs 3";
VUHDO_I18N_TT.K252 = "Choisir une couleur pour les HoT carrйs 4";
VUHDO_I18N_TT.K253 = "Choisir une couleur pour les HoT carrйs 5";
VUHDO_I18N_TT.K254 = "Choisir une couleur pour les HoTs avec une faible durйe";
VUHDO_I18N_TT.K255 = "Choisir la durйe de l'avertissement et de la couleur qui sera appliquйe et la prйcision (secs/10) qui sera affichйe.";
VUHDO_I18N_TT.K256 = "Cochez pour avoir un contour autour du compteur des HoT et du texte de la minuterie.";
VUHDO_I18N_TT.K257 = "Cochez pour avoir une ombre derriиre le compteur des HoT et du texte de la minuterie.";
VUHDO_I18N_TT.K258 = "Cochez pour voir la durйe de couleur de l'alerte des HoT restants est infйrieur а configurй pour la gauche.";
VUHDO_I18N_TT.K260 = "Cochez pour la disparition des icфnes/carrйs quand les Hot sont presque йpuisйs";
VUHDO_I18N_TT.K261 = "Choisissez une couleur pour vos debuffs autodйfinis";
VUHDO_I18N_TT.K262 = "Cochez pour avoir aussi les icфnes des debuff volant dedans.";
VUHDO_I18N_TT.K263 = "Cette option permet de sйlectionner que les debuffs que vous voulez voir.";
VUHDO_I18N_TT.K264 = "Sйlectionnez cette option pour les buffs et debuffs personnalisйs que vous voulez voir.";
VUHDO_I18N_TT.K265 = "Les panneaux Wizards vous permettent de crйer vos groupes de panneau avec seulement quelques clics.";
VUHDO_I18N_TT.K266 = "Cochez l'affichage personnalisй des (de)buffs par icфnes.";
VUHDO_I18N_TT.K267 = "Cochez l'affichage personnalisй des (de)buffs par barre de couleur";
VUHDO_I18N_TT.K268 = "Cochez pour voir l'effet d'animation sur les icфnes.";
VUHDO_I18N_TT.K269 = "Cochez pour voir le compteur de durйe restant sur les icфnes.";
VUHDO_I18N_TT.K270 = "Dйplacer pour changer l'йchelle des icфnes de (de)buff.";
VUHDO_I18N_TT.K271 = "Dйplacer pour dйterminer le max. nombre de (de)buffs а montrer а la fois.";
VUHDO_I18N_TT.K272 = "Sйlectionnez un son qui sera jouй pour un debuff personnalisй.";
VUHDO_I18N_TT.K273 = "Cochez pour montrer le mode de (de)buffs par icфne.";
VUHDO_I18N_TT.K274 = "Cochez pour montrer le mode de (de)buffs par une barre de couleur.";
VUHDO_I18N_TT.K275 = "Cochez pour voir l'effet d'animation sur les icфnes.";
VUHDO_I18N_TT.K276 = "Cochez pour voir le compteur de durйe restant sur les icфnes.";
VUHDO_I18N_TT.K279 = "Sйlectionnez un son qui sera jouй quand un joueur gagne un debuff";
VUHDO_I18N_TT.K280 = "Cliquez ici pour appliquer le programme d'installation choisi pour vos panneaux";
VUHDO_I18N_TT.K281 = "Cochez cette case pour avoir un panneau supplйmentaire pour les vйhicules les familiers. Tous les clics de souris cibleront le vйhicule/familier.";
VUHDO_I18N_TT.K282 = "Cochez cette case pour avoir un panneau supplйmentaire pour les familiers";
VUHDO_I18N_TT.K283 = "Cochez cette option pour avoir un panneau supplйmentaire pour les joueurs en cible, mais gardй secret pour vous.";
VUHDO_I18N_TT.K284 = "Cochez cette case pour avoir un panneau supplйmentaire pour les Tanks";
VUHDO_I18N_TT.K285 = "Sйlectionnez cette option pour afficher toutes les unitйs RAID non groupйes. Il s'agit d'un point de vue simple, mais clair.";
VUHDO_I18N_TT.K286 = "Sйlectionnez cette option pour afficher toutes les unitйs RAID regroupйes selon leur rфle: DPS mкlйe, mкlйe Tanks, DPS distance, Guйrisseurs.";
VUHDO_I18N_TT.K287 = "Sйlectionnez cette option pour afficher toutes les unitйs RAID regroupйes selon leur classe.";
VUHDO_I18N_TT.K288 = "Sйlectionnez cette option pour afficher toutes les unitйs RAID groupйes par numйro de groupe (1-8).";
...
VUHDO_I18N_TT.K291 = "Cochez pour commencer votre cast en relвchant le bouton de la souris au lieu de la pression.";
VUHDO_I18N_TT.K292 = "Cochez pour afficher l'info-bulles standard au lieu de VuhDo.";
VUHDO_I18N_TT.K298 = "Si vous cochez ce bouton, l'arrangement actuel sйlectionnй va automatiquement s'activer si vous кtes en SOLO.";
VUHDO_I18N_TT.K299 = "Si vous cochez ce bouton, l'arrangement actuel sйlectionnй va automatiquement s'activer si vous кtes dans un groupe, maximum 5 joueurs.";
VUHDO_I18N_TT.K300 = "Si vous cochez ce bouton, l'arrangement actuel sйlectionnй va automatiquement s'activer si vous кtes dans un raid maximum 10 joueurs.";
VUHDO_I18N_TT.K301 = "Si vous cochez ce bouton, l'arrangement actuel sйlectionnй va automatiquement s'activer si vous кtes dans un raid maximum 25 joueurs.";
VUHDO_I18N_TT.K302 = "Si vous cochez ce bouton, l'arrangement actuel sйlectionnй va automatiquement s'activer si vous кtes dans un raid de plus de 25 joueurs.";
VUHDO_I18N_TT.K306 = "Cliquez pour changer la couleur de votre barre en couleur de santй.";
VUHDO_I18N_TT.K307 = "Cochez pour avoir la croissance au lieu de faire rйtrйcir les barres si un joueur perd de la vie.";-------review
VUHDO_I18N_TT.K308 = "Cochez pour avoir une barre de santй а la verticale au lieu d'horizontale.";-------
VUHDO_I18N_TT.K309 = "Cochez cette case pour afficher l'icфne dans la barre de santй du raid.";
VUHDO_I18N_TT.K310 = "Cochez cette option pour aligner les barres de santй en horizontale plutфt que verticalement";
VUHDO_I18N_TT.K311 = "Sйlectionnez cette option pour toujours vous montrer au dessus de votre groupe (barre de santй en premier).";
VUHDO_I18N_TT.K312 = "Dйfinis l'ancrage des panneaux dans la partie supйrieure centrale.";
VUHDO_I18N_TT.K313 = "Dйfinis les panneaux d'ancrage au centre en bas.";
VUHDO_I18N_TT.K314 = "Dйfinis les panneaux d'ancrage au centre gauche.";
VUHDO_I18N_TT.K315 = "Dйfinis les panneaux d'ancrage au centre droit.";
VUHDO_I18N_TT.K316 = "Trier le joueur dans un groupe par leur max. HP.";
VUHDO_I18N_TT.K317 = "Sйlection pour trier par groupe de classes";
VUHDO_I18N_TT.K318 = "Sйlectionnez la largeur de vos barres de Hot";
VUHDO_I18N_TT.K320 = "Choisir le Hot pour votre 3e emplacement."; -- нету в актуале
VUHDO_I18N_TT.K321 = "Choisir le Hot pour votre 2e emplacement."; -- нету в актуале
VUHDO_I18N_TT.K322 = "Choisir le Hot pour votre 1e emplacement."; -- нету в актуале
VUHDO_I18N_TT.K325 = "Cochez pour afficher HoT icфnes en haut а gauche de la barre de santй";
VUHDO_I18N_TT.K326 = "Cochez pour afficher HoT icфnes en bas а droite de la barre de santй";
VUHDO_I18N_TT.K327 = "Cochez pour afficher HoT icфnes а gauche dessous la barre de santй";
VUHDO_I18N_TT.K328 = "Cochez pour afficher HoT icфnes en bas а droite de la barre de santй";
VUHDO_I18N_TT.K329 = "Cochez pour afficher HoT icфnes а gauche dessous la barre de santй";
VUHDO_I18N_TT.K331 = "Activer cette option pour afficher des Hot carrйs utiliser mats au lieu de la texture brillante";
VUHDO_I18N_TT.K332 = "Sйlectionnez un Hot pour votre 5e logement. Le logement numйro 5 ne sera pas affichй quand les carrйs en couleur sont choisis au lieu des icфnes"; -- нету в актуале
VUHDO_I18N_TT.K333 = "Sйlectionnez un Hot pour votre 4e logement."; -- нету в актуале
VUHDO_I18N_TT.K334 = "Sйlectionnez un Hot pour votre 3e logement."; -- нету в актуале
VUHDO_I18N_TT.K335 = "Sйlectionnez un Hot pour votre 2e logement."; -- нету в актуале
VUHDO_I18N_TT.K336 = "Sйlectionnez un Hot pour votre 1e logement."; -- нету в актуале
VUHDO_I18N_TT.K337 = "Configure la faзon dont vous voulez que vos icфnes Hot se ressemblent.";
VUHDO_I18N_TT.K338 = "Configure la faзon dont vous voulez que vos barres HoT se ressemblent.";
VUHDO_I18N_TT.K339 = "Dйplacer pour changer l'йchelle de la totalitй des panneaux.";
...
VUHDO_I18N_TT.K343 = "Sйlectionnez le nombre max. de caractиres pour le nom du joueur.";
VUHDO_I18N_TT.K344 = "Sйlectionnez une police pour les noms des joueurs sur les barres de santй.";
VUHDO_I18N_TT.K345 = "Cochez cette option pour rester dans votre position actuelle au lieu de cliquer sur la barre de santй et de l'unitй. Vous changerez automatiquement votre position";
VUHDO_I18N_TT.K346 = "Cocher pour activer les infos-bulles des infos de sort";
VUHDO_I18N_TT.K347 = "Cochez cette option pour faire des clics de souris \"partout\" а l'arriиre-plan du panneau pour permettre le ciblage, en mouvement. Si cette option est sйlectionnйe, vous ne serez pas en mesure de montrer qui est le chef de raid, etc. en utilisant le clique droit.";
...
VUHDO_I18N_TT.K350 = "Cochez pour afficher le nombre de piles sur les icфnes personnalisйes des debuff.";
VUHDO_I18N_TT.K351 = "Sйlectionnez pour l'ancrage des debuffs personnalisй en haut а gauche des barres de santй.";
VUHDO_I18N_TT.K352 = "Sйlectionnez pour l'ancrage des debuffs personnalisй en haut а droite des barres de santй.";
VUHDO_I18N_TT.K353 = "Sйlectionnez pour l'ancrage des debuffs personnalisй en bas а gauche des barres de santй.";
VUHDO_I18N_TT.K354 = "Sйlectionnez pour l'ancrage des debuffs personnalisй en bas а droite des barres de santй.";
VUHDO_I18N_TT.K355 = "Ajustez la position des icфnes personnalisйes des debuff dans le sens vertical.";
VUHDO_I18N_TT.K356 = "Ajustez la position des icфnes personnalisйes des debuff dans le sens horizontal";
VUHDO_I18N_TT.K357 = "Sйlectionnez cette option pour afficher le nom du familier/vйhicule dans le nom du texte.";
VUHDO_I18N_TT.K358 = "Sйlectionnez cette option en hors de combat fonctionnalitй de ciblage intelligent";
VUHDO_I18N_TT.K359 = "Sйlectionnez une touche de modification pour l'associer avec un cast vif et avec.";
VUHDO_I18N_TT.K360 = "Sйlectionnez cette option pour dйclencher automatiquement le rez combat sur les joueurs morts (druides seulement)";
VUHDO_I18N_TT.K361 = "Sйlectionnez pour afficher les barres cible а gauche des barres de santй."
VUHDO_I18N_TT.K362 = "Sйlectionnez pour afficher les barres cible а droite des barres de santй."
VUHDO_I18N_TT.K363 = "Sйlectionnez la sensibilitй du flash dommages. Une valeur plus grande signifie plus de clignotement (en bas/dommages).";
VUHDO_I18N_TT.K364 = "Cochez pour cacher le texte de vie si la vie est au-dessus de dйclenchement.";
VUHDO_I18N_TT.K365 = "Cochez pour appliquer le systиme des Hot (Options=>Paneaux=>HoTs) quand la disposition des sorts change.";
VUHDO_I18N_TT.K366 = "Cochez cette case pour viser l'unitй que vous guйrissez en mкme temps";
VUHDO_I18N_TT.K367 = "Ce menu vous permet de choisir, quel type de soin entrant sera dйtectй.";
VUHDO_I18N_TT.K368 = "Choisissez le dernier point dans l'avenir dont vous voulez voir directement les cast а partir de."; -- нету в актуале
VUHDO_I18N_TT.K369 = "Cochez pour afficher les nouveaux soins arrivant en direct des cast."; -- нету в актуале
VUHDO_I18N_TT.K370 = "Sйlectionnez le dernier point а l'avenir que vous voulez voir canalisй guйrit de."; -- нету в актуале
VUHDO_I18N_TT.K371 = "Cochez pour afficher des soins entrants provenant des soins canalisйs."; -- нету в актуале
VUHDO_I18N_TT.K372 = "Select the latest point in the future you want to see HoTs from."; -- нету в актуале
VUHDO_I18N_TT.K373 = "Cochez pour afficher les soins entrants des Hots."; -- нету в актуале
VUHDO_I18N_TT.K374 = "Select the latest point in the future you want to see bombed heals from."; -- нету в актуале
VUHDO_I18N_TT.K375 = "Cochez pour afficher incoming heals from bombed heals (atm: Life Bloom effect)."; -- нету в актуале
VUHDO_I18N_TT.K376 = "Select to align groups at the bottom of the panel (at the right, when \"horizontal\" is selected above).";
VUHDO_I18N_TT.K377 = "Sйlectionnez une texture pour les bordures du panneau.";
VUHDO_I18N_TT.K378 = "Sйlectionnez une taille pour le panneau des bordures de frontiиre.";
VUHDO_I18N_TT.K379 = "Select an inset size for panel borders.";
VUHDO_I18N_TT.K380 = "Cochez cette case pour ne pas vous voir dans un raid rйguliиrement.";
...
VUHDO_I18N_TT.K384 = "Sort du Raid trier par ordre donnй en \"dйplacer!\". Cette sйlection ne fonctionnera que si l'arrangement est \"dйtacher\" est а йtй sйlectionnй ci-dessus.";
VUHDO_I18N_TT.K385 = "Choisissez une couleur de la barre de santй qui sera appliquйe si cette amйlioration est manquante sur le joueur.";
VUHDO_I18N_TT.K386 = "Permets de changer la couleur de la barre si cette amйlioration est manquante.";
VUHDO_I18N_TT.K387 = "Augmenter la prioritй de cette amйlioration.";
VUHDO_I18N_TT.K388 = "Diminuer la prioritй pour cette amйlioration.";
VUHDO_I18N_TT.K389 = "Choisissez une couleur pour les HoT carrйs 6";
VUHDO_I18N_TT.K390 = "Vйrifiez pour inverser le tri.";
...
VUHDO_I18N_TT.K396 = "Fixe les composants d'ancrage а gauche.";
VUHDO_I18N_TT.K397 = "Fixe les composants d'ancrage en haut.";
VUHDO_I18N_TT.K398 = "Fixe les composants d'ancrage en bas";
VUHDO_I18N_TT.K399 = "Fixe les composants d'ancrage а droite.";
...
VUHDO_I18N_TT.K409 = "Cache les panneaux lorsque vous кtes en solo.";
VUHDO_I18N_TT.K410 = "Hides panels when you are in a party of up to five";
VUHDO_I18N_TT.K411 = "Organisation des couleurs pour les icфnes cibles du raid";
VUHDO_I18N_TT.K412 = "Cliquez ici pour copier ces paramиtres par dйfaut а tous les debuffs personnalisйs";
VUHDO_I18N_TT.K413 = "Choisissez une couleur pour les debuff personnalisйs";
VUHDO_I18N_TT.K414 = "Sйlectionnez les icфnes de raid а afficher";
VUHDO_I18N_TT.K415 = "Choisissez une couleur pour le texte de l'overheal";
VUHDO_I18N_TT.K416 = "Cochez pour afficher les icфnes de raid par couleur de la barre/couleur du texte.";
VUHDO_I18N_TT.K417 = "Vйrifiez pour n'afficher que les icфnes de raid par la couleur qui sont activйes dans Panneaux=>Misc";
VUHDO_I18N_TT.K418 = "Choisissez une couleur pour cette icфne de raid.";
VUHDO_I18N_TT.K419 = "Mode Tank ne regarde que la situation de menace pour la dйtection d'aggro. les ennemis occasionnels qui font un ciblage sur les joueurs seront ignorйs";
VUHDO_I18N_TT.K420 = "Option unique Prкtre: Afficher l'icфne capacitй restante de boucliers. Ceci est expйrimental.";
VUHDO_I18N_TT.K421 = "Choisissez une couleur si l'unitй est en pleine santй.";
VUHDO_I18N_TT.K422 = "Choisissez une couleur si la vie de l'unitй est de taille moyenne.";
VUHDO_I18N_TT.K423 = "Choisissez une couleur si la vie est faible."
VUHDO_I18N_TT.K425 = "Rйglez la vitesse а laquelle les groupes seront rafraоchis. Peuvent avoir un impact sur les performances du systиme";
VUHDO_I18N_TT.K426 = "Choisissez une gamme dans laquelle deux unitйs sont considйrйes comme un groupe";
VUHDO_I18N_TT.K427 = "Sйlectionnez un max. niveau de santй au-dessus duquel est considйrйe une unitй comme une cible qui mйrite un sort de soin";
VUHDO_I18N_TT.K428 = "Sйlectionnez un nombre minimum de personnes qui pour кtre une cible lйgitime de votre groupe de soins";
VUHDO_I18N_TT.K429 = "Sйlectionnez un nombre minimum de personnes qui pour кtre une bonne cible de votre groupe de soins.";
VUHDO_I18N_TT.K430 = "Sйlectionnez cette option si votre sort de soins de groupe part de vous (pas de la cible elle-mкme)";----review
VUHDO_I18N_TT.K431 = "Sйlectionnez cette option si votre sort de guйrison de groupe part de la cible (pas de vous, par ex. Le cercle de Guйrison)";----review
VUHDO_I18N_TT.K432 = "Sйlectionnez cette option si tous les membres du raid sont affectйs par le sort(Salve de guйrison, Cercle de soins).";
VUHDO_I18N_TT.K433 = "Sйlectionnez si seulement les membres du raid dans le groupe de la cible bйnйficieront de votre sort (Priиre de soins)";
VUHDO_I18N_TT.K435 = "Cette option active l'affichage du nombre de personnes dans le pфle situй dans l'icфne HoT";
VUHDO_I18N_TT.K436 = "Affiche la recharge global sur la barre.";
VUHDO_I18N_TT.K437 = "Dйtecte le groupe directement autour de la cible.";
VUHDO_I18N_TT.K438 = "Dйtecte le groupe de la cible а proximitй avec un dйficit de santй."
VUHDO_I18N_TT.K439 = "Sйlectionnez le nombre maximal de fois oщ votre chaоne de soins passera а une autre cible.";
VUHDO_I18N_TT.K440 = "Choisissez une couleur pour le nombre de joueurs dans un groupe est classй juste.";
VUHDO_I18N_TT.K441 = "Choisissez une couleur pour le nombre de joueurs dans un groupe qui est jugйe bonne.";
...
VUHDO_I18N_TT.K484 = "Enables PallyPower compatible remote blessing and aura setup communications"; -- нету в актуале
...
VUHDO_I18N_TT.K549 = "Si vous cochez ce bouton, l'arrangement actuel sйlectionnй va automatiquement s'activer si vous кtes dans un raid maximum 20 joueurs.";
VUHDO_I18N_TT.K550 = "Afficher un raid de 20 joueurs pour test.";
VUHDO_I18N_TT.K551 = "Si vous cochez ce bouton, l'arrangement actuel sйlectionnй va automatiquement s'activer si vous кtes dans un raid maximum 30 joueurs.";
...
VUHDO_I18N_APPLY_TO_ALL = "appliquez а tous";
...
VUHDO_I18N_ICONS = "Icфnes";
VUHDO_I18N_COUNTDOWN = "Compte а rebours";
VUHDO_I18N_APPLIANCES = "Appliances";
VUHDO_I18N_FADE_OUT = "Disparaоtre";
...
VUHDO_I18N_IICONSI = "[Icфnes]";
VUHDO_I18N_ISQUARESI = "[Carrйs]";
VUHDO_I18N_HOT_ORDER = "Ordre des Hot";
VUHDO_I18N_SLOT_6 = "Slot 6 (out-most)"; -- нету в актуале
VUHDO_I18N_SLOT_5 = "Slot 5"; -- нету в актуале
VUHDO_I18N_SLOT_4 = "Slot 4"; -- нету в актуале
VUHDO_I18N_SLOT_3 = "Slot 3"; -- нету в актуале
VUHDO_I18N_SLOT_2 = "Slot 2"; -- нету в актуале
VUHDO_I18N_SLOT_1 = "Slot 1 (in-most)"; -- нету в актуале
...
VUHDO_I18N_SPELL_ADVICE = "Utilisez le programme d'installation standard de WoW raccourcis clavier pour assigner des sorts ci-dessous pour les touches. (Allez а l'en-tкte de «VuhDo«.)";
VUHDO_I18N_SAVE_AS = "Enregistrer sous...";
VUHDO_I18N_MOVE = "Dйplacer!";
...
VUHDO_I18N_PANEL_SCALE = "йchelle des panneaux";
VUHDO_I18N_MAX_CHARS = "Max.caractиre (0=All)";
-- #+v1.178
...
VUHDO_I18N_HOSTILE_ADVICE_3 = "Bijoux/Instants ne se dйclenchent pas en automatique!!!"
-- Slider
VUHDO_I18N_WARN_PREC_AT = "Alerter / la prйcision de";
VUHDO_I18N_MAX_NO_DE_BUFFS = "Max. # (de)buffs";
VUHDO_I18N_BRIGHTNESS = "Luminositй";
VUHDO_I18N_RAID_ICON_SCALE = "Йchelle des icфnes de raid";
...
VUHDO_I18N_OUT_OF_RANGE = "Hors de portйe";
...
VUHDO_I18N_SQUARE_1 = "Carrй 1";
VUHDO_I18N_SQUARE_2 = "Carrй 2";
VUHDO_I18N_SQUARE_3 = "Carrй 3";
VUHDO_I18N_SQUARE_4 = "Carrй 4";
VUHDO_I18N_SQUARE_5 = "Carrй 5";
...
VUHDO_I18N_CURSE = "Malйdiction";
VUHDO_I18N_MAGIC = "Magique";
VUHDO_I18N_HEADER = "En-tкte";
VUHDO_I18N_TARGET_NAME = "Nom de la cible";
VUHDO_I18N_BORDER = "Bordure";
VUHDO_I18N_ANOUNCE_RESURRECTION = "annoncent la rйsurrection";
...
VUHDO_I18N_25 = " 25";
VUHDO_I18N_40 = " 40";
VUHDO_I18N_DEBUFF_DEFAULTS = "(De)Buff Par dйfaut";
...
VUHDO_I18N_MISC_TEXT = "Misc. Texte"; -- нету в актуале
VUHDO_I18N_EXPIRY_WARNING = "Avertissement d'expiration";
VUHDO_I18N_COUNTDOWN_OFF = "Compte а rebours: Off";
VUHDO_I18N_SECS = "secs";
VUHDO_I18N_SECS_10 = "sec/10";
VUHDO_I18N_FULL_DURATION = "durйe totale";
...
VUHDO_I18N_UNIT = "Unitй";
VUHDO_I18N_SOLIDD = "Solid";
VUHDO_I18N_HORIZONTAL = "Horizontal";
VUHDO_I18N_SLOT_1_2 = "Slot 1"; -- нету в актуале
VUHDO_I18N_FLAT_TEXTURE = "Texture mat";
VUHDO_I18N_HOT_ICONS = "HoT Icфnes";
...
VUHDO_I18N_EDGE_INSETS = "Rebord insйrer";
-- #+1.204
VUHDO_I18N_IGNORE_PETS = "Ignore Pets";
VUHDO_I18N_PANEL_MODEL = "Panneau de modиle";
-- #+1.207
...
VUHDO_I18N_IHEALTH_BARI = "[Barre santй ]";
VUHDO_I18N_SQUARE_6 = "Carrй 6";
VUHDO_I18N_GLOSSY = "Brillant";
VUHDO_I18N_DAMAGE_FLASH = "Dmg.Flash";
VUHDO_I18N_SENSIVITY = "Sensibilitй";
VUHDO_I18N_HIDE_IRRELEVANT = "Hide irrel.";
VUHDO_I18N_CASTED = "Direct"; -- нету в актуале
VUHDO_I18N_CHANNELLED = "Canalisйs"; -- нету в актуале
VUHDO_I18N_BOMBED = "Bombardй"; -- нету в актуале
VUHDO_I18N_EVENT_HORIZON = "Horizon d'Йvйnement"; -- нету в актуале
VUHDO_I18N_ALGINMENT = "Alignement";
VUHDO_I18N_BOTTOM = "Bas";
VUHDO_I18N_PET_OWNERS = "Propriйtaire Pкt";
...
VUHDO_I18N_HEALTH_LEVEL = "Niveau de Santй <";
VUHDO_I18N_CLUSTER_FINDER = "Groupe trouvй";
