...
if (not HealComm.compressGUID or not HealComm.fixedCompress) then
	...
	HealComm.compressGUID = setmetatable({}, {__index = function(tbl, guid)
	...
	HealComm.decompressGUID = setmetatable({}, {__index = function(tbl, str)
...
if (not HealComm.rankNumbers) then
	HealComm.rankNumbers = setmetatable({}, {__index = function(tbl, index)
...
if (not HealComm.spellToID) then
	HealComm.spellToID = setmetatable({}, {__index = function(tbl, index)
...
HealComm.averageHealMT = HealComm.averageHealMT or {__index = function(tbl, index)
...
function HealComm:GetGUIDUnitMapTable()
	if (not HealComm.protectedMap) then
		HealComm.protectedMap = setmetatable({}, {__index = function(tbl, key)
		return HealComm.guidToUnit[key] end,
